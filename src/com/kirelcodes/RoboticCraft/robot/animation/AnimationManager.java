...
public class AnimationManager {
	public static final AnimationCycle walk = new AnimationCycle(
			...
			new AnimationFrame().setLeftLeg(new EulerAngle(0, 0, 0))
					.setRightLeg(new EulerAngle(0, 0, 0)), new AnimationFrame()
					.setLeftLeg(new EulerAngle(-0.5, 0, 0)).setRightLeg(
							new EulerAngle(0.5, 0, 0)), new AnimationFrame()
					.setLeftLeg(new EulerAngle(0, 0, 0)).setRightLeg(
